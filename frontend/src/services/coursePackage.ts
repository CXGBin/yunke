...
export async function createCoursePackage(data: Partial<API.CoursePackage>) {
...
export async function updateCoursePackage(id: number, data: Partial<API.CoursePackage>) {
